...
\input{secciones/cap6/Derivada de la función logística}
\input{secciones/cap6/Esquema general del entrenamiento}
\input{secciones/cap6/Función de error con entropía cruzada}
\input{secciones/cap6/Derivada de la función logística}
\input{secciones/cap6/Parcial con respecto a los pesos en la última capa}
\input{secciones/cap6/Parcial con respecto a los pesos en la penúltima capa}
\input{secciones/cap6/Vectorización}
