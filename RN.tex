...
\input{secciones/Capitulo3/00AprendizajeMaquina}
\input{secciones/Capitulo3/01Espacio_de_hipotesis}
%\section{Conjuntos de entrenaiento, validación y prueba}
\input{secciones/Capitulo3/03Perceptron}
\input{secciones/Capitulo3/04Compuertas_lógicas_con_neuronas}
\input{secciones/Capitulo3/05FuncionesDeActivacion}
\input{secciones/Capitulo3/06Funciones_de_error}
%Funciones_de_error: diferencias al cuadrado y entropía cruzada
\input{secciones/Capitulo3/07Medidas_de_rendimiento}
