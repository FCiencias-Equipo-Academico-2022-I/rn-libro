...
\input{secciones/Antecedentes/Neuronabiologica/NeurocienciasComputacionales}
\input{secciones/Antecedentes/Neuronabiologica/SistemaNervioso} 
\input{secciones/Antecedentes/Neuronabiologica/NeuronaBiologica}

\chapter{Modelo de Hodgkin-Huxley}
\input{secciones/Antecedentes/ModeloHodkinHuxley/ModeloHH}

\chapter{Aprendizaje de máquina}
\input{secciones/Antecedentes/AprendizajeMaquina/01Aprendizaje_Maquina}
\input{secciones/Antecedentes/AprendizajeMaquina/02Espacio_de_hipotesis}
\input{secciones/Antecedentes/AprendizajeMaquina/03Clasificacion_de_los_conjuntos_de_datos}
...
\input{secciones/PerceptronSimple/02Compuertas_logicas_con_neuronas}
\input{secciones/PerceptronSimple/03Funciones_de_activacion}
\input{secciones/PerceptronSimple/04Funciones_de_error}
\input{secciones/PerceptronSimple/05Medidas_de_rendimiento}

\chapter{Perceptrón multicapa}
\input{secciones/PerceotronMulticapa/00Intro}
\input{secciones/PerceotronMulticapa/01XOR}
\input{secciones/PerceotronMulticapa/02Propagacion_hacia_adelante_manual}
\input{secciones/PerceotronMulticapa/03Propagacion_hacia_adelante_m}%Propagación hacia adelante vectorizada (con matrices)
\input{secciones/PerceotronMulticapa/04Interpretacion} %Interpretación matemática del mapeo no lineal
\input{secciones/PerceotronMulticapa/05Propagacion_hacia_adelante_multicapa} %Propagación hacia adelante para el perceptrón multicapa

%%
\chapter{Entrenamiento por retropropagación}

\input{secciones/EntrenamientoRetropropagacion/01Esquema general del entrenamiento}
\input{secciones/EntrenamientoRetropropagacion/02Función de error con entropía cruzada}
\input{secciones/EntrenamientoRetropropagacion/03Derivada de la función logística}
...
\input{secciones/OptimizacionEntrenamiento/01Problemas en redes profundas}
\input{secciones/OptimizacionEntrenamiento/02Gradiente desvaneciente}
\input{secciones/OptimizacionEntrenamiento/03Entrenamiento en línea vs en lotes}
\input{secciones/OptimizacionEntrenamiento/04Normalización y normalización por lotes}
\input{secciones/OptimizacionEntrenamiento/05Regularización}
...
\input{secciones/EntrenamientoGeneticos/021Antecedentes: Aprendizaje por refuerzo en videojuegos}
\input{secciones/EntrenamientoGeneticos/022Arquitectura para estimar la función de recompensa}
\input{secciones/EntrenamientoGeneticos/023Entrenamiento}

%\part{Aprendizaje no supervisado}
\chapter{Mapeos autoorganizados}
\input{secciones/cap10/00Introducción}
\input{secciones/cap10/01Aprendizaje no supervisado}
\input{secciones/cap10/02Mapeos autoo-organizados}
