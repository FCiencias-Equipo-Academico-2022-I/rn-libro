...
\input{secciones/PerceptronMulticapa/00Intro}
\input{secciones/PerceptronMulticapa/01XOR}
\input{secciones/PerceptronMulticapa/02Propagacion_hacia_adelante_manual}
\input{secciones/PerceptronMulticapa/03Propagacion_hacia_adelante_m}%Propagación hacia adelante vectorizada (con matrices)
\input{secciones/PerceptronMulticapa/04Interpretacion} %Interpretación matemática del mapeo no lineal
\input{secciones/PerceptronMulticapa/05Propagacion_hacia_adelante_multicapa} %Propagación hacia adelante para el perceptrón multicapa
...
\input{secciones/OptimizacionEntrenamiento/05Regularizacion}
