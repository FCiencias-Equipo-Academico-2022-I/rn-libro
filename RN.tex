...
\input{secciones/cap1/NeurocienciasComputacionales}
\input{secciones/cap1/SistemaNervioso} 
\input{secciones/cap1/NeuronaBiologica}

\chapter{Modelo de Hodgkin-Huxley}
\input{secciones/cap2/ModeloHH}

\chapter{Aprendizaje de máquina}
\input{secciones/cap3/01Aprendizaje_Maquina}
\input{secciones/cap3/02Espacio_de_hipotesis}
\input{secciones/cap3/03Clasificacion_de_los_conjuntos_de_datos}
%\section{Conjuntos de entrenaiento, validación y prueba}


\part{Redes dirigidas acíclicas}
\chapter{Perceptrón simple}
\input{secciones/cap4/01Perceptron}
\input{secciones/cap4/02Compuertas_logicas_con_neuronas}
\input{secciones/cap4/03Funciones_de_activacion}
\input{secciones/cap4/04Funciones_de_error}
\input{secciones/cap4/05Medidas_de_rendimiento}

\chapter{Perceptrón multicapa}
\input{secciones/cap5/00Intro}
\input{secciones/cap5/01XOR}
\input{secciones/cap5/02Propagacion_hacia_adelante_manual}
\input{secciones/cap5/03Propagacion_hacia_adelante_m}%Propagación hacia adelante vectorizada (con matrices)
\input{secciones/cap5/04Interpretacion} %Interpretación matemática del mapeo no lineal
