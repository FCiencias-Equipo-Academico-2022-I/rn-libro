...
\input{secciones/Neuronabiologica/NeurocienciasComputacionales}
\input{secciones/Neuronabiologica/SistemaNervioso} 
\input{secciones/Neuronabiologica/NeuronaBiologica}

\chapter{Modelo de Hodgkin-Huxley}
\input{secciones/ModeloHodkinHuxley/ModeloHH}

\chapter{Aprendizaje de máquina}
\input{secciones/AprendizajeMaquina/01Aprendizaje_Maquina}
\input{secciones/AprendizajeMaquina/02Espacio_de_hipotesis}
\input{secciones/AprendizajeMaquina/03Clasificacion_de_los_conjuntos_de_datos}
...
\input{secciones/cap5/05Propagacion_hacia_adelante_multicapa} %Propagación hacia adelante para el perceptrón multicapa

%%
\chapter{Entrenamiento por retropropagación}

\input{secciones/cap6/01Esquema general del entrenamiento}
\input{secciones/cap6/02Función de error con entropía cruzada}
\input{secciones/cap6/03Derivada de la función logística}
...
\input{secciones/cap7/01Problemas en redes profundas}
\input{secciones/cap7/02Gradiente desvaneciente}
\input{secciones/cap7/03Entrenamiento en línea vs en lotes}
\input{secciones/cap7/04Normalización y normalización por lotes}
...
\input{secciones/cap9/021Antecedentes: Aprendizaje por refuerzo en videojuegos}
