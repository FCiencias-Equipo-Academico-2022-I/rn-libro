...
La transmisión de señales y almacenamiento de información en las neuronas se da de la siguiente forma:
...
\begin{description}
 \item [Sinapsis eléctrica:] las membranas de las células pre y posinápticas se unen en la brecha sináptica por una unión tipo brecha (\textit{gap}), o unión comunicante, que son pequeños canales que permiten el paso de iones (\fref{fig:sinapsisN}).
...
\end{figure}
 ...
 \item [Sinapsis química:] la neurona libera moléculas neurotransmisoras a otra neurona adyacente en un pequeño espacio, la brecha sináptica (\fref{fig:sinapsisQ}). Su funcionamiento se puede resumir en cuatro etapas principales:
